...
//        fragmentView.addView(navigationBar, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, 0, Gravity.BOTTOM | Gravity.FILL_HORIZONTAL));
    ...
    private void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        items.add(SettingCell.Factory.of(4, IconBackgroundColors.BLUE_LIGHT.top, IconBackgroundColors.BLUE_LIGHT.bottom, R.drawable.settings_scout, "Scout Preference", "Stealth Mode, Force Screenshot"));
        ...
        items.add(SettingCell.Factory.of(14, IconBackgroundColors.BLUE_LIGHT.top, IconBackgroundColors.BLUE_LIGHT.bottom, R.drawable.outline_saved_24, getString(R.string.SavedMessages)));
    ...
    private void onClick(UItem item, View view, int position, float x, float y) {
        ...
        switch (item.id) {
            case 4:
                presentSettingFragment(new ScoutPreferenceActivity());
                break;
            case 1:
